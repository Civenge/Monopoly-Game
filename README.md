...
* create_spaces - takes two parameters: the amount of money given to players when they land on or pass the "GO" space, and an LIST of 24 integers (rent amounts)
  ...
  * Creates exactly 24 more game spaces (for a total of 25):
    ...
    * Spaces will have rent amounts initialized from the LIST of 24 rent values.
